programa
{
	...
	funcao inicio()
	{
		...
		senao se (sexoPessoa =='F')
		{
			...
			senao se (idade<60) {
				escreva("Bom dia Sra. "+nomePessoa+" sua idade aproximada é "+idade+" anos e vc é considerado adulta")		
			}
			senao se (idade>=60) {
				escreva("Bom dia Sra. "+nomePessoa+" sua idade aproximada é "+idade+" anos e vc é considerado idosa")	
			}		
		...
		senao
		{
			se (idade<18)
			{
				escreva("Bom dia Srx "+nomePessoa+" sua idade aproximada é "+idade+" anos e vc é considerada jovex")		
			}
			senao se (idade<60) {
				escreva("Bom dia  Srx"+nomePessoa+" sua idade aproximada é "+idade+" anos e vc é considerado adulta")		
			}
			senao se (idade>=60) {
				escreva("Bom dia  Srx"+nomePessoa+" sua idade aproximada é "+idade+" anos e vc é considerado idosx")	
			}		
		}
		escreva("\nFIM DE PROGRAMA!!")
	}
